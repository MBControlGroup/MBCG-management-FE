                  ...
                  <SectionBody>
                      ...
                      <Section1RC>
                          ...
                          {this.props.task.currentPeopleLoc.slice().map((item, index) => {
                                if (item.soldier_id === this.props.task.activeSoldierID) {
                                    return (
                                        <HLRow onClick={() => this.setState({ showIMWindow: true})}>
                                ...
                                return (
                                    <Row onClick={() => this.setState({ showIMWindow: true })}>
                                      <TableCell>{item.soldier_id}</TableCell>
                                      <TableCell>{item.name}</TableCell>
                                      <TableCell>{item.phone}</TableCell>
                                      <TableCell>{item.serve_office}</TableCell>
              ...
              <Section>
                  ...
                  <SectionBody2>
                      <Section1_InfoContainer>
                              <InfoCell>
                                  <p>需要人数</p>
                                  <h2>{this.props.task.currentResponseDetail === null ? '' : this.props.task.currentResponseDetail.mem_count}</h2>
                                </InfoCell>
                              <InfoCell>
                                  <p>通知人数</p>
                                  <h2>{this.props.task.currentResponseDetail === null ? '' : this.props.task.currentResponseDetail.notify_count}</h2>
                                </InfoCell>
                              <InfoCell>
                                  <p>响应人数</p>
                                <h2>{this.props.task.currentResponseDetail === null ? '' : this.props.task.currentResponseDetail.response_count}</h2>
                                </InfoCell>
                              <InfoCell>
                                  <p>接受人数</p>
                                <h2>{this.props.task.currentResponseDetail === null ? '' : this.props.task.currentResponseDetail.accept_count}</h2>
                                </InfoCell>
                                <InfoCell>
                                    <p>平均响应时间</p>
                                <h2>{this.props.task.currentResponseDetail === null ? '' : this.props.task.currentResponseDetail.avg_resp_time}</h2>
                                </InfoCell>
                            </Section1_InfoContainer>
                            <TableContainer>
                            <Table dataSource={this.props.task.currentResponseDetail ? this.props.task.currentResponseDetail.mem_list.slice() : []} columns={rescolumns} />
                            </TableContainer>
                    </SectionBody2>
                </Section>
                ...
                <Section>
                    ...
                    <SectionBody2>
                        <Section1_InfoContainer>
                            <InfoCell>
                                <p>实到人数</p>
                                <h2>{this.props.task.currenGatherDetail === null ? '' : this.props.task.currenGatherDetail.check_count}</h2>
                            </InfoCell>
                            <InfoCell>
                                <p>应到人数</p>
                                <h2>{this.props.task.currenGatherDetail === null ? '' : this.props.task.currenGatherDetail.total_mem}</h2>
                            </InfoCell>
                            <InfoCell>
                                <p>集合时间</p>
                                <h2>{this.props.task.currentTaskDetail === null ? '' : this.props.task.currentTaskDetail.gather_datetime.slice(this.props.task.currentTaskDetail.gather_datetime.indexOf(' ') + 1, this.props.task.currentTaskDetail.gather_datetime.length)}</h2>
                        ...
                        <TableContainer>
                            <Table dataSource={this.props.task.currentResponseDetail ? this.props.task.currenGatherDetail.mem_list.slice() : []} columns={gathercolumns} />
                        </TableContainer>
                    </SectionBody2>
                </Section>
